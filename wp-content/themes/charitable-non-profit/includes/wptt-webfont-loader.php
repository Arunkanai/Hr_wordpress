...
if ( ! class_exists( 'Charitable_Non_Profit_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Charitable_Non_Profit_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Charitable_Non_Profit_WPTT_WebFont_Loader( $url );
