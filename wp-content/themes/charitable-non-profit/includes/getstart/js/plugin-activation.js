jQuery(document).ready(function($) {
    'use strict';
    var this_obj = charitable_non_profit_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.charitable-non-profit-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message charitable-non-profit-plugin-install');
                button.addClass('button-primary charitable-non-profit-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.charitable-non-profit-recommended-plugins .charitable-non-profit-activation-note').css('display','block');
    ...
    $(document).on('click', '.charitable-non-profit-plugin-activate', function(event) {
