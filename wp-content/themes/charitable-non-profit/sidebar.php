...
<div class="sidebar-area">
  <?php if ( ! dynamic_sidebar( 'charitable-non-profit-sidebar' ) ) : ?>
    <div role="complementary" aria-label="sidebar1" id="archives" class="sidebar-widget">
        <h4 class="title" ><?php esc_html_e( 'Archives', 'charitable-non-profit' ); ?></h4>
        <ul>
            <?php wp_get_archives( array( 'type' => 'monthly' ) ); ?>
        </ul>
    </div>
    <div role="complementary" aria-label="sidebar2" id="meta" class="sidebar-widget">
        <h4 class="title"><?php esc_html_e( 'Meta', 'charitable-non-profit' ); ?></h4>
        <ul>
            <?php wp_register(); ?>
